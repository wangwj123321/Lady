        ...
        <div id="list">
            <ul>
                <c:forEach var="product" items="${ProductPage.list }">
	                <li>
	                    <a href="${pageContext.request.contextPath}/servlet/getProductExtByProductNo?productNo=${product.productNo }"><img src="${pageContext.request.contextPath}/images/${product.picpath }" alt=""></a>
	                    <p><a href="">${product.productName }</a></p>
	                     <p><a href="">${product.productNo }</a></p>
